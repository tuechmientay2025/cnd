...
(function () {
    ...
    d = function (a, b) {
        ...
        return setTimeout(a.confirmUp, 1e3 * 5)
    ...
    }, setTimeout(g, 1e3 * 5), window.Offline = a
}).call(this), function () {
...
jQuery('document').ready(function ($) {
    ...
    Offline.on('confirmed-down', function () {
        ...
        jQuery('#offline_counter').remove('#offline_count').append('<span id="offline_count"></span>');
