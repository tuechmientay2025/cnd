jQuery(document).ready(function ($) {
    ...
    window.POS_CART = {
        ...
        has_enough_stock: function (product_data, quantity) {
            ...
            var has_enough_stock = product_data.managing_stock === false || product_data.backorders_allowed === true || product_data.stock_quantity >= quantity || (product_data.manage_stock == false && product_data.stock_status == "instock");
        ...
        calculate_totals: function () {
            ...
            $.each(cart, function (cart_item_key, values) {
                ...
                if (values.variation_id > 0) {
                    ...
                    if(_product.tax_status === "taxable"){
                        _product['taxable'] = true;
                        _product['tax_class'] = _product['tax_class'] == "parent" ? "" : _product['tax_class'];
                    }
                }
