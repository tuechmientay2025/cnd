            ...
            APP.db.values('products', Object.keys(pos_grid.tile_styles)).done(function(products){
                $.each(products, function (i, record) {
                    ...
                    if (typeof record.type != 'undefined' && record.type == 'variable' && record.variations.length > 0 && pos_grid.tile_variables == 'tiles') {
                        ...
                        var $li = $('<li id="product_' + record.id + '" class="title_product add_grid_tile category_cycle" data-slug="'+record.name.make_slug()+'" data-id="' + record.id + '" title="'+record.name+'"><span></span><span class="price"></span></li>');
                    }
                ...
                $.each(products, function(index, product){
                    if(in_array(product.id, search_pr)){
                        ...
                        if (product.type == 'variable' && product.variations.length > 0 && pos_grid.tile_variables == 'tiles') {
                            ...
                            var $li = $('<li id="product_' + product.id + '" class="title_product add_grid_tile category_cycle" data-slug="'+product.name.make_slug()+'" data-id="' + product.id + '" title="'+product.name+'"><span></span><span class="price"></span></li>');
                        }
