Handlebars.registerHelper('displayProductItemTitle', function() {
	...
	var variation_id   = this.cart_item_data.variation_id;
	var title          = product.name||product.title;
	...
	if(wc_pos_params.image_size == 'thumbnail'){
		if(product.thumbnail_src){
			...
			if(product.images&&product.images.length > 0){
			    ...
			    var string = '<img width="90" height="90" src="https://placehold.co/125x125/cecece/333/png?text=P" class="attachment-shop_thumbnail wp-post-image">';
			}
...
Handlebars.registerHelper('displayProductItemMeta', function() {
    ...
    return string&&string!="undefined"?new Handlebars.SafeString(string):"";
});
