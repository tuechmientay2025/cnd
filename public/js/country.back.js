                ...
                var url = "https://provinces.open-api.vn/api/p/";
                    fetch(url).then(function(r){return r.json()}).then(function(res){
                      ...
                      select.on("change",function(e){
                        ...
                        fetch(`https://provinces.open-api.vn/api/p/${this.value}?depth=2`).then(function(r){return r.json()}).then(function(res){
                          ...
                          district.on("change",function(e){
                            ...
                            fetch(`https://provinces.open-api.vn/api/d/${this.value}?depth=2`).then(function(r){return r.json()}).then(function(res){
